...
<body>
  ...
  <div class="text-center">
    <img id="breathing-button"
      src="https://raw.githubusercontent.com/Daniel-Garcia-Mazatan/GCW/master/rail%20road%20playing.png" alt="">
  </div>
  <br>
  <section class="stage">
  ...
  <div class="foot">
    <div class="text-center">
      <audio id="myAudio" src="C:/Users/diego/Music/My Train's A Comin' - Unicorn Heads.mp3" autoplay loop></audio>
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                aria-controls="pills-home" aria-selected="true">Sign in</a>
            </li>
            <li class="nav-item">
              ...
              <form name="myForm" action="game.php">
                ...
                <div class="form-group">
                  <div class="text-center">
                    ...
                    <button type="button" class="btn btn-light"><span class="material-icons"
                        style="font-size: 18px; color: #3b5998;">facebook</span> Facebook</button>
                    <br><br>
  ...
  <script>
    ...
    var firebaseConfig = {
      apiKey: "AIzaSyAKyKwp5mKcS4_l5LbEwTcKoqzovieZrw0",
      authDomain: "uanl-fcfm.firebaseapp.com",
      databaseURL: "https://uanl-fcfm-default-rtdb.firebaseio.com/",
      projectId: "uanl-fcfm",
      storageBucket: "uanl-fcfm.appspot.com",
      messagingSenderId: "473073142129",
      appId: "1:473073142129:web:115a0b04a7a48825c8ced0",
      measurementId: "G-5QZMM1TP5K"
    };
    // Initialize Firebase
