        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (let index = 0; index < objectLength; index++) {
                    ...
                    $(".masdatos").append("<h1>"+ Object.values(data[index].nombre).join("")+"</h1><br><img src='uploads/"+ Object.values(data[index].foto).join("")+"' alt='foto'><h1>WINS!</h1><input type='text' value="+ Object.values(data[index].puntos).join("") +" disabled>");
